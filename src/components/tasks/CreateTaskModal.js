...
export default function CreateTaskModal({ open, onClose, form, setForm, onCreate }) {
  ...
  return (
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="sm">
        ...
        <Box sx={{ display: "flex", flexDirection: "column", gap: 2.5, pt: 1 }}>
          ...
          <Box display="flex" gap={2}>
            <FormControl fullWidth>
              ...
              <Select name="projectId" value={form.projectId || ""} label="Project" onChange={handleChange}>
                <MenuItem value=""><em>None</em></MenuItem>
                {projects.map(proj => <MenuItem key={proj.id} value={proj.id}>{proj.name}</MenuItem>)}
              </Select>
            </FormControl>
          ...
          <Box sx={{ display: "flex", gap: 2 }}>
            <FormControl fullWidth>
              ...
              <Select name="priority" value={form.priority || "medium"} label="Priority" onChange={handleChange}>
      ...
      <DialogActions sx={{ p: 2 }}>
        ...
        <Button onClick={onCreate} variant="contained" color="primary">Create Task</Button>
      </DialogActions>
    </Dialog>
  );
}